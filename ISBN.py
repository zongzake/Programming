#โจทย์ข้อนี้สนใจเฉพาะ ISBN ที่มี 10 หลัก การตรวจสอบความถูกต้องของ ISBN จะใช้ตัวเลขหลักสุดท้ายเป็น Check Digit ในการตรวจสอบความถูกต้องของตัวเลขอื่นๆโดยวิธีที่ใช้ตรวจสอบคือ
#(10*n1)+(9*n2)+(8*n3)+(7*n4)+(6*n5)+(5*n6)+(4*n7)+(3*n8)+(2*n9)+(n10) จะต้องหารด้วย 11 ลงตัว
